...
// discutor sobre interfaces naturales
// proponer interfacesa naturales que sean inovadoras
//hiptesis ob generales, obj especificos
...
void MainWindow::on_OpenImage_clicked()
{
    ...
    histograma();
        ...
        scene->addPixmap(Loadimage);
        scene->setSceneRect(Loadimage.rect());*/
        //ui->graphicsView->setScene(scene);
        //ui->label->setPixmap(QPixmap::fromImage(Loadimage));
}

void MainWindow::on_Equalisacion_clicked()
{
    histograma();
    Mat dst;
